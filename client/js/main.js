...
(function ($) {
  ...
  $(document).ready(function () {
    $("#filterform").on("click", function (event) {
      ...
      // Check if no vehicle is available (you can modify this condition according to your specific logic)

      $("#error-dialog").fadeIn();
    });

    $("#error-dialog").on("click", function () {
      // Hide the error dialog when clicked outside the dialog box
      $(this).fadeOut();
    });
  });
