function generateContactMail(Name, Sub){
                ...
                <div class="u-col u-col-100" style="max-width: 320px; min-width: 600px; display: table-cell; vertical-align: top;">
                  <div style="height: 100%; width: 100% !important;">
                    ...
                    <div style="box-sizing: border-box; height: 100%; padding: 0px; border: 0px solid transparent;">
                      ...
                      <table id="u_content_text_11" style="font-family: 'Cabin',sans-serif;" role="presentation" border="0" width="100%" cellspacing="0" cellpadding="0">
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding" style="overflow-wrap: break-word; word-break: break-word; padding: 15px; font-family: 'Cabin',sans-serif;" align="left">
                              <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 160%; text-align: left; margin: 0px;">Thankyou! ${Name} for contacting us, we have received your query <strong>${Sub}</strong></p>
                                <p style="font-size: 14px; line-height: 160%; text-align: left; margin: 0px;">Team get-Wheels will reply you as soon as possible.</p>
                              </div>
                            </td>
                          </tr>
                        </tbody>
...
module.exports = {generateContactMail};