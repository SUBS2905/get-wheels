...
function generateOtpTemplate(otp){
    const otpTemplate = `<input name="cloudhq_backup_comment_node" type="hidden" value="%5Bif%20gte%20mso%209%5D%3E%0A%3Cxml%3E%0A%20%20%3Co%3AOfficeDocumentSettings%3E%0A%20%20%20%20%3Co%3AAllowPNG%2F%3E%0A%20%20%20%20%3Co%3APixelsPerInch%3E96%3C%2Fo%3APixelsPerInch%3E%0A%20%20%3C%2Fo%3AOfficeDocumentSettings%3E%0A%3C%2Fxml%3E%0A%3C!%5Bendif%5D"> 
                      ...
                      <div style="box-sizing: border-box; height: 100%; padding: 0px; border: 0px solid transparent;">
                        ...
                        <div>
                          <div style="text-align: left;">
                            <div>
                              <div>Do not share your secret otp with anyone. Otp will be valid for 5 mins only. <br><strong>OTP: ${otp}</strong> <br>
                              <br>Thankyou for choosing getWheels!<br></div>
                            </div>
                          </div>
                        </div>
                        <br>
